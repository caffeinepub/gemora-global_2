...
export async function loadConfig(): Promise<Config> {
  ...
  try {
    ...
    const fullConfig = {
      ...
      storage_gateway_url: (process.env.STORAGE_GATEWAY_URL && process.env.STORAGE_GATEWAY_URL !== "nogateway") ? process.env.STORAGE_GATEWAY_URL : DEFAULT_STORAGE_GATEWAY_URL,
